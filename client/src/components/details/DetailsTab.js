      ...
      <div className="px-4 md:px-10 lg:px-12">
        ...
        >
          <div className="w-full max-w-[20vw] h-fit aspect-[0.67/1] hidden lg:block bg-nav">
            <LazyImage
              src={
                data && data.poster_path ? poster + data.poster_path : EmptyCard
              }
          ...
          <div className="w-full">
            <h2
              className="text-xl font-medium mb-4 md:mb-5"
              data-cy="information-headline"
            >
              Summary
            </h2>
            <p className="mb-8 md:mb-10" data-cy="information-overview">
              {data?.overview}
            </p>
            <div className="grid grid-cols-1 gap-1 lg:grid-cols-2 2xl:grid-cols-1 mb-10">
              ...
              {data && data.networks && (
                <div className="grid grid-cols-2">
                  ...
                  <span>{data?.networks.map((d) => d.name).join(", ")}</span>
                </div>
              )}
            </div>
