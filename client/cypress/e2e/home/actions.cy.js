...
describe("Perform actions on the homepage", () => {
  ...
  // Check explore movies button
  it("Check explore movies button", () => {
  ...
  // Check explore shows button
  it("Check explore shows button", () => {
    cy.getCypress("carousel-item-link").should("exist");
    cy.getCypress("carousel-item-link").should("be.visible");
