// Perform actions on the movies page
describe("Perform actions on the movies page", () => {
  ...
  // Check explore now playing movies button
  it("Check explore movies now playing button", () => {
    ...
    cy.url().should("include", "/category/now-playing");
    cy.go("back");
  });

  // Check explore upcoming movies button
  it("Check explore upcoming movies button", () => {
    cy.getCypress("carousel-item-link").should("exist");
    cy.getCypress("carousel-item-link").should("be.visible");
    cy.getCypress("carousel-heading-explore-button").last().click();
    cy.getCypress("card-listing-item").should("exist");
    cy.getCypress("card-listing-item").should("be.visible");
    cy.url().should("include", "/category/upcoming");
    cy.go("back");
  });

  // Check the first movie card
  it("Check the first movie card", () => {
    cy.getCypress("carousel-item-link").should("exist");
    cy.getCypress("carousel-item-link").should("be.visible");
  ...
  // Check the last movie card
  it("Check the last movie card", () => {
    cy.getCypress("carousel-item-link").should("exist");
    cy.getCypress("carousel-item-link").should("be.visible");
